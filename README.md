...
<img src="./files/preview.gif" width="300" alt="animated preview">
...
dependencies {
    ...
    implementation 'com.github.lincollincol:amplituda:v2.3.1' // or newer version
}
```
...
<com.masoudss.lib.WaveformSeekBar
    ...
    app:wave_starting_point="left_to_right"
...
|  wave_starting_point  |          Enum           |  `waveStartingPoint`  | Waves Srating point, default is `WaveStartingPoint.LEFT_TO_RIGHT`                                                                                                                                                   |
